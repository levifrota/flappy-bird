...
const velJogo = urlParams.get('velocidade-jogo');
const personagens = urlParams.get('personagens');
const tipoJogo = urlParams.get('tipo-jogo');
...
function Barreiras(altura, largura, abertura, espaco, notificarPonto) {
    ...
    abertura = parseInt(intervalo)
    espaco = parseInt(distancia)
...
function Passaro(alturaJogo) {
    ...
    if (personagens === 'delorean') {
        this.elemento.src = 'img/delorean.png'
    ...
    this.animar = () => {
        velocidadePersonagem = parseInt(velPersonagem)
        const novoY = this.getY() + (voando ? velocidadePersonagem : -5)
...
function FlappyBird(
    ...
    const barreiras = new Barreiras(altura, largura, parseInt(intervalo), parseInt(distancia),
